class Api::V1::Accounts::ConversationsController < Api::V1::Accounts::BaseController
  ...
  def whatsapp_groups_participants
    render json: { error: 'Invalid inbox type' }, status: :unprocessable_entity if @conversation.inbox.whatsapp?
    render json: { error: 'Invalid contact identifier' }, status: :unprocessable_entity if @conversation.contact.identifier.blank?
