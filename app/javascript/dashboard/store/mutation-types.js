export default {
  ...
  SET_ALL_MESSAGES_PREVIOUS_LOADED: 'SET_ALL_MESSAGES_PREVIOUS_LOADED',
  ...
  UPDATE_CONVERSATIONS_ORDER: 'UPDATE_CONVERSATIONS_ORDER',
  ...
  SET_PREVIOUS_CONVERSATIONS_CONTACTS: 'SET_PREVIOUS_CONVERSATIONS_CONTACTS',
  ...
  SET_ACCOUNT_PERMISSIONS: 'SET_ACCOUNT_PERMISSIONS',
  UPDATE_ACCOUNT_PERMISSION: 'UPDATE_ACCOUNT_PERMISSION',
  ...
  SET_LABELS_USAGE_COUNT: 'SET_LABELS_USAGE_COUNT',
  ...
  // Ticket Label
  SET_TICKET_LABELS_UI_FLAG: 'SET_TICKET_LABELS_UI_FLAG',
  SET_TICKET_LABELS: 'SET_TICKET_LABELS',
  SET_TICKET_ADD_LABEL: 'ADD_LABEL',
  SET_TICKET_DELETE_LABEL: 'DELETE_LABEL',
  SET_TICKET_CUSTOM_ATTRIBUTES: 'SET_TICKET_CUSTOM_ATTRIBUTES',
  SET_TICKET_SEND_NOTIFICATION: 'SET_TICKET_SEND_NOTIFICATION',
  SET_TICKET_AGENT_ID: 'SET_TICKET_AGENT_ID',
  // Reports
  SET_TRIGGERS_REPORTS: 'SET_TRIGGERS_REPORTS',
  SET_TRIGGERS_REPORTS_PROCESSED: 'SET_TRIGGERS_REPORTS_PROCESSED',
  SET_TRIGGERS_REPORTS_METRICS: 'SET_TRIGGERS_REPORTS_METRICS',
  TOGGLE_TRIGGER_REPORT_LOADING: 'TOGGLE_TRIGGER_REPORT_LOADING',
  TOGGLE_TRIGGER_REPORT_PROCESSED_LOADING:
    'TOGGLE_TRIGGER_REPORT_PROCESSED_LOADING',
  TOGGLE_TRIGGER_REPORT_METRIC_LOADING: 'TOGGLE_TRIGGER_REPORT_METRIC_LOADING',
  ...
  TOGGLE_AGENT_CONVERSATION_METRIC_LOADING:
    'TOGGLE_AGENT_CONVERSATION_METRIC_LOADING',
  SET_TICKETS_REPORT: 'SET_TICKETS_REPORT',
  SET_TICKETS_REPORT_METRIC: 'SET_TICKETS_REPORT_METRIC',
  SET_TICKETS_UI_FLAG_REPORT: 'SET_TICKETS_UI_FLAG_REPORT',
  SET_TEAMS_METRICS: 'SET_TEAMS_METRICS',
  TOGGLE_TEAMS_METRICS_LOADING: 'TOGGLE_TEAMS_METRICS_LOADING',

  // Invoices
  SET_INVOICES_USAGE: 'SET_INVOICES_USAGE',
  SET_INVOICES_SUMMARY_USAGE: 'SET_INVOICES_SUMMARY_USAGE',
  SET_INVOICES: 'SET_INVOICES',
  SET_INVOICES_UI_FLAG: 'SET_INVOICES_UI_FLAG',
  ...
  SET_TICKETS_UI_FLAG_PAGE: 'SET_TICKETS_UI_FLAG_PAGE',
  SET_TICKETS_PAGINATION: 'SET_TICKETS_PAGINATION',
  SET_TICKETS: 'SET_TICKETS',
  SET_TICKET: 'SET_TICKET',
  SET_TICKETS_STATS: 'SET_TICKETS_STATS',
  SET_TICKETS_LABELS: 'SET_TICKETS_LABELS',
  ...
  SET_CONVERSATION_PARTICIPANTS_WHATSAPP:
    'SET_CONVERSATION_PARTICIPANTS_WHATSAPP',
